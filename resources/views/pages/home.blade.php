...
@section('content')
        ...
        <section class="py-16 flex items-center justify-between gap-10 px-4">
            <div class="flex flex-col gap-6 max-w-lg">
                <div>
                    ...
                    <p class="text-base-content/50 mt-3">ТекстТекстТекст</p>
                </div>

                <div class="flex items-center gap-4 mt-10">
                    <a href="{{ route('subjects')}}" class="btn btn-primary text-base-100 font-normal transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-lg active:scale-95">
                        К предметам
                    </a>
                    <a href="{{route('profile')}}"
                       class="btn text-secondary font-normal bg-base-100 transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-md active:scale-95">
                        В профиль
                    </a>
                </div>
            </div>
    ...
    <div class="border-t border-base-200"></div>
        ...
        <section class="py-16 flex items-center gap-10 px-4">
            <div class="hidden md:block w-[420px] shrink-0">
                <video autoplay loop muted playsinline class="w-full object-contain">
                    <source src="{{ asset('videos/hero.mp4') }}" type="video/mp4">
                </video>
    ...
    <div class="border-t border-base-200"></div>
        ...
        <div class="hidden md:block w-[380px] shrink-0">
            <img src="{{ asset('#') }}" alt="Предметы" class="w-full object-contain">
        </div>
